    ...
    return (
        <div className="min-h-screen bg-[#faf7fc] flex flex-col justify-center">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <Link href="/">
                    <div className="mx-auto text-center">
                        <h2 className="font-serif text-3xl font-semibold tracking-tight text-[#4a0340] py-8">DRID UNIBEN</h2>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white py-8 px-6 rounded-2xl border border-[#e6d9e6] shadow-[0_20px_60px_-40px_rgba(109,3,92,0.5)] sm:px-10">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div>
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    className="appearance-none block w-full px-3 py-2.5 border border-[#e0d3e0] rounded-lg shadow-sm placeholder-[#a48fa0] focus:outline-none focus:ring-2 focus:ring-[#6d035c]/20 focus:border-[#6d035c] sm:text-sm"
                        ...
                        <div>
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-full text-sm font-semibold text-white bg-[#6d035c] hover:bg-[#4a0340] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6d035c]/30 disabled:bg-[#a48fa0] disabled:cursor-not-allowed transition-colors"
                            >
                                {isLoading ? (
                                    <>
            ...
            <footer className="mt-auto bg-[#f4eef3]">
